...
const COMMANDS: Cmd[] = [
  ...
  { id: "import", label: "Import your list", hint: "From AniList or MyAnimeList", href: "/import", keywords: "import anilist mal myanimelist migrate move list sync", icon: I(<><path d="M12 3v12M8 11l4 4 4-4" /><path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2" /></>) },
